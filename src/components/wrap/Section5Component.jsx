...
export default function Section5Component(){
    ...
    React.useEffect(()=>{
        ...
        function mainSlide(){
            ...
            $('.slide-wrap').stop().animate({left: `${-100*cnt}%` }, 100, function(){
                if(cnt > 13) cnt=0;  // 슬라이드 14개인데 0부터 세면 0,1,2...13이 된다 
                if(cnt < 0) cnt=13;  // 13번이 되면 0으로 돌아간다
            });
                            ...
                            <ul className='slide-wrap'>
                                <li className='slide slide1'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis1.jpg" alt="" /></a>
                                    </div>
                                ...
                                <li className='slide slide2'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis2.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide3'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis3.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide4'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis4.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide5'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis5.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide6'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis6.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide7'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis7.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide8'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis8.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide9'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis9.png" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide10'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis10.png" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide11'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis11.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide12'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis12.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide13'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis13.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
                                ...
                                <li className='slide slide14'>
                                    <div className="img-box">
                                        <a href="#"><img src="./images/sec5img/tennis14.jpg" alt="" /></a>
                                    </div>
                                    <div className="txt-box">
