...
import WomenAllThird1ChildComponent from './WomenAllThird1ChildComponent'

export default function WomenAllThird1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub3/womenAll.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenAllThird1ChildComponent 전체보기={state.전체보기} />
              {/* <ul>
                <li>
