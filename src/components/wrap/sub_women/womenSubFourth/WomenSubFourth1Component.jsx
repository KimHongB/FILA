...
import WomenSubFourth1ChildComponent from './WomenSubFourth1ChildComponent'

export default function WomenSubFourth1Component () {
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenSubFourth1ChildComponent 온라인단독={state.온라인단독} />
              {/* <ul>
                <li>
