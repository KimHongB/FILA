...
import WomenAllFourth1ChildComponent from './WomenAllFourth1ChildComponent'

export default function WomenAllFourth1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub4/womenAll.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenAllFourth1ChildComponent 전체보기={state.전체보기} />
              {/* <ul>
                <li>
