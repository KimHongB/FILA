...
import WomenSubFourth2ChildComponent from './WomenSubFourth2ChildComponent'

export default function WomenSubFourth2Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub4/womenSub.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
        ...state,
        라이프웨어: res.data.라이프웨어
      })
    })
    .catch((err)=>{
          ...
          <div className="gap">
            <div className="title">
              <div className="left-box">
                <ul>
                  ...
                  <li>
                     <h3><img src="./img/HSM/women_all/mola.svg" alt="" /></h3> 
                  </li>
                  <li>
                    <h2>언더웨어</h2>
                  </li>
              ...
              <div className="right-box">
                <ul>
                  ...
                  <li className='img1'>
                    <img src="./img/HSM/women_all/ico_col3_off_24x24.png" alt="" />
                  </li>
                  <li className='img2'>
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenSubFourth2ChildComponent 라이프웨어={state.라이프웨어} />
              {/* <ul>
                <li>
