...
import WomenAllSecond1ChildComponent from './WomenAllSecond1ChildComponent'

export default function WomenAllSecond1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub2/womenAll.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
        ...
        <main id="womenall2">
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <ul>
              {state.전체보기.map((item,idx) => {
                return (
                  <WomenAllSecond1ChildComponent
                    key={item.제품코드}
                    item={item}
                    idx={idx}
                  />
