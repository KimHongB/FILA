...
import WomenSubSecond2ChildComponent from './WomenSubSecond2ChildComponent'

export default function WomenSubSecond2Component () {
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <ul>
                  {state.라이프스타일.map((item, idx)=>{
                      return (
                        <WomenSubSecond2ChildComponent 
                        key={item.제품코드}
                        item={item}
                        idx={idx} />
                      )
