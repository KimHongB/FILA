...
import WomenAllFirst1ChildComponent from './WomenAllFirst1ChildComponent'

export default function WomenAllFirst1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub1/womenAll.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenAllFirst1ChildComponent 전체보기={state.전체보기} />
              </div>           
            </div>
          </div>
          </div>
