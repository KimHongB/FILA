...
import WomenSubFirst1ChildComponent from './WomenSubFirst1ChildComponent'

export default function WomenSubFirst1Component () {
  ...
  const getProduct=()=>{
    axios({
      url:'./data/womenSub1/womenSub.json',
      method:'GET'
    })
    .then((res)=>{
      setState({
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenSubFirst1ChildComponent 티셔츠={state.티셔츠} />
              {/* <ul>
                <li>
