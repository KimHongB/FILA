...
import WomenSubFirst2ChildComponent from './WomenSubFirst2ChildComponent';

export default function WomenSubFirst2Component () {
          ...
          <div className="gap">
            ...
            <div className="content">
              ...
              <div className="right-main">
                <WomenSubFirst2ChildComponent 반바지={state.반바지} />
              {/* <ul>
                <li>
