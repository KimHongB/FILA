...
import MenSubThird1ChildComponent from './MenSubThird1ChildComponent'

export default function MenSubThird1Component () {
          ...
          <div className="gap">
            ...
            <div className="left-option">
              ...
              <div className="right-main">
                <MenSubThird1ChildComponent 메신저백={state.메신저백} />
              </div>           
            </div>
          </div>
          </div>
