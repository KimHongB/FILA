...
import MenSubFirst1ChildComponent from './MenSubFirst1ChildComponent'

export default function MenSubFirst1Component () {
          ...
          <div className="gap">
            ...
            <div className="content">
                  ...
                  <div className="left-content">
                    <div className="category">
                      ...
                      <div className="category2">
                        <ul>
                          <li>
                            <h3  onClick={onClikcCol3} className={`col-agree1${state.isCol3 ? ' on' : ''}`}>스포츠</h3><img  src="./img/HSM/men_all/up.svg" alt=""  onClick={onClikcCol3} className={`col-agree1${state.isCol3 ? ' on' : ''}`}/>
                          </li>
                          <ul className={`agree-box1 ${state.isCol3 ? ' on' : ''}`}>
                      ...
                      <div className="category3">
                        <button className={`agree${state.isCol1? ' on':'' }`} onClick={onClickisCol1}>색상</button>
                        <ul className={`agree${state.isCol1? ' on':'' }`}>
                      ...
                      <div className="category4">
                        <button className={`agree ${state.isCol2? ' on':''}`} onClick={onClickisCol2}>사이즈</button>
                      ...
                      <div className="category6">
                        <ul>
                          <li>
                            <h3 onClick={onClickisCol5}>성별</h3><img src="./img/HSM/men_all/up.svg" alt="" onClick={onClickisCol5}  className={`agree3 ${state.isCol5? ' on':''}`}/>
                          </li>
                          <ul className={`agree3 ${state.isCol5? ' on':''}`}>
              ...
              <div className="right-main">
                <MenSubFirst1ChildComponent 반바지={state.반바지} />
              </div>           
            </div>
          </div>
          </div>
