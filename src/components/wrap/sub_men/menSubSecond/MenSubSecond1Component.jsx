...
import MenSubSecond1ChildComponent from './MenSubSecond1ChildComponent'

export default function MenSubSecond1Component () {
          ...
          <div className="gap">
            ...
            <div className="left-option">
              ...
              <div className="right-main">
                <MenSubSecond1ChildComponent 샌들슬리퍼={state.샌들슬리퍼} />
              </div>           
            </div>
          </div>
          </div>
