...
import MenAllSecond1ChildComponent from './MenAllSecond1ChildComponent'

export default function MenAllSecond1Component () {
          ...
          <div className="gap">
            ...
            <div className="left-option">
                      ...
                      <div className="category2">
                        <ul>
                          ...
                          <ul className={`agree-box1 ${state.isCol2 ? ' on' : ''}`}>
                            ...
                            <li><label htmlFor="user_agree2"><input type="checkbox" name="userAgree2" id="user_agree2" />러닝</label></li>
                            <li><label htmlFor="user_agree3"><input type="checkbox" name="userAgree3" id="user_agree3" />라이프스타일</label></li>
              ...
              <div className="right-main">
                <MenAllSecond1ChildComponent 전체보기={state.전체보기} />
              {/* <ul>
                <li>
