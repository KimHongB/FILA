...
import MenSubFourth1ChildComponent from './MenSubFourth1ChildComponent'

export default function MenSubFourth1Component () {
          ...
          <div className="gap">
            ...
            <div className="left-option">
              ...
              <div className="right-main">
                <MenSubFourth1ChildComponent 라이프웨어={state.라이프웨어} />
              </div>           
            </div>
          </div>
          </div>
