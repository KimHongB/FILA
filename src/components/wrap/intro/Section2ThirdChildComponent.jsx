...
export default function Section2ThirdChildComponent  ({온라인단독})  {
    ...
    React.useEffect(()=>{
        const slideCount=$('.wrap3 .slide').length;
        const slideWrap=$('#section2 .wrap3');
    ...
    return (
        <div className="slide-container" draggable="false">
            <div className="slide-view" draggable="false">                    
                <ul className='slide-wrap wrap3' draggable="false">
                {
                    온라인단독.map((item)=>{
                        return(
