...
export default function Section2FifthChildComponent  ({TENIS})  {
    ...
    React.useEffect(()=>{
        const slideCount=$('.wrap5 .slide').length;
        const slideWrap=$('#section2 .wrap5');
    ...
    return (
        <div draggable="false" className="slide-container" >
            <div draggable="false" className="slide-view">                    
                <ul draggable="false" className='slide-wrap wrap5'>
                {
                    TENIS.map((item)=>{
                        return(
