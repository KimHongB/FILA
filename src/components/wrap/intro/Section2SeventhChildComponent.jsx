...
export default function Section2SeventhChildComponent  ({썸머슈즈})  {
    ...
    React.useEffect(()=>{
        const slideCount=$('.wrap7 .slide').length;
        const slideWrap=$('#section2 .wrap7');
    ...
    return (
        <div draggable="false" className="slide-container">
            <div draggable="false" className="slide-view">                    
                <ul draggable="false" className='slide-wrap wrap7'>
                {
                    썸머슈즈.map((item)=>{
                        return(
